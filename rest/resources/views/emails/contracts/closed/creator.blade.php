...
<p>Hey {{$creator}},<br>
we are happy to inform you that you successfully closed the <strong>contract #{{$contract->id}}</strong> with your counterparty {{$recipient}}. The contract has a due date of {{$expirationDate->formatLocalized('%d %b %Y')}}. Thank you for using the Jur Beta Platform for your needs we hope that you liked the experience.<br>
