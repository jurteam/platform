...
<p>Hey {{$creator}},<br>
your cunterparty {{$recipient}} to the contract {{$contract->address}} which has a due date of {{$expirationDate->formatLocalized('%d %b %Y')}} <strong>has sent you a friendly resolution</strong> in order to amend the contract's conditions. If you like the proposal, press on <i>Accept</i>. In case you do not feel free to open a dispute by pressing the <i>Dispute</i> button.<br>
