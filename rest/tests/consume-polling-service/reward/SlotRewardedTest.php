...
class SlotRewardedTest extends TestCase
{
    ...
    private $body = [
        ...
        'contract_address' => '0x65F2BCA97cAf8429cBB34e6146197FA12cDDE417',
        'block_number' => 6606106,
        'transaction_hash' => '0x6c8dc783c83285c26b2465e5896ac773c91bbd3f2bb6d0c3c75eb0602b6769f5',
        'sender' => '0x2d9241a6c709c8ba3a35c1ad17667641ffe27067',
        'timestamp' => 1592922345,
        'data' => ["slotId" => "0", "activityId" => "17", "rewardAmount" => "1000000000000000000"]
    ];
    ...
    public function should_validate_un_assigned_state_in_database()
    {
        ...
        $slot = Slot::where('sc_slot_id', 0)->where('reward_activity_id', $activity->id)->firstOrFail();
        // validate database
        $this->seeInDatabase('rewards', [
            'slot_id' => $slot->id,
            'rewardee_wallet' => '0x2D9241a6c709c8Ba3a35C1aD17667641FFE27067',
            'reward_amount' => 1,
            'rewarded_on' => Carbon\Carbon::createFromTimestamp(1592922345)
        ]);
    }
}
