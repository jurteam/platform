...
export const ContractSetPenaltyFee = ({contract, ContractSetPenaltyFee, setPenaltyFeeStatus}) => {
  ...
  return (
    <div className="jur-contract-set-penalty-fee">
      ...
      <div className={`jur-contract-set-penalty-fee__values ${isActive ? 'jur-contract-set-penalty-fee__values--active' : ''}`}>
